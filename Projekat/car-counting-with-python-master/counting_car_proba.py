...
def funkcija():
    ...
    while (1):
        ...
        pom = Sensor1.car_number_detected
        ...
        if k == 27:
            break
brojac = Sensor1.car_number_detected
'''
def funkcija2():
    
     result = firebase.put("/IoT-Brojac","Vale",brojac)
     #sleep(3000)
     print(result)
'''   
funkcija()
#t1 =  threading.Thread(target = funkcija, name = 't1')
#t2 = threading.Thread(target= funkcija2,name='t2')
